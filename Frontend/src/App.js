...
import SearchReviews from "./components/SearchReviews"; // Create this component
import RecommendProduct from "./components/RecommendProduct"; // Create this component
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* Product Pages */}
        <Route
          path="/products/doorbells"
          element={<AdvancedSmartDoorbells addToCart={addToCart} />}
        />
        <Route
          path="/products/doorlocks"
          element={<SmartDoorlocks addToCart={addToCart} />}
        />
        <Route
          path="/products/lightings"
          element={<SmartLightings addToCart={addToCart} />}
        />
        <Route
          path="/products/speakers"
          element={<SmartSpeakers addToCart={addToCart} />}
        />
        <Route
          path="/products/thermostats"
          element={<VideoDoorbellPro addToCart={addToCart} />}
        />
        <Route
          path="/products/:id"
